    ...
    for ser in series:
        ...
        for filename in serlist:
           ...
           # if sample_name[:3] == 'G_5': 
                ...
                if not sample_name[:3] in ['D_1', 'D_4', 'C_5', 'C_4']: continue 
                print(sample_name)
...
np.save(os.path.join(toppath, 'volume_hist_dump_v2_clean_repeats.npy'), results)
...
data.to_netcdf(os.path.join(toppath, 'CL_grayvalue_histograms_v2_clean_repeats.nc'))
